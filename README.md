...
This repo provides examples for fitting, diagnosing, and visualizing linear model predictions. 
...
The rendered pdf for the abalone linear model is [here](https://github.com/lucia-murillo/workshop-07_spring-2026/blob/main/code/abalone-example.pdf). 